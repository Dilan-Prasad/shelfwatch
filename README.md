...
- **reddit.com is not in Exa's index** and blocks direct requests; the Reddit surface is served through pages
  that quote Reddit (RedditRecs etc.) and is labelled *indirect*.
